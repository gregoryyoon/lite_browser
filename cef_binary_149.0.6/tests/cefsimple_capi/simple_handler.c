        ...
        if (strcmp(action, "toggle-ai-sidepanel") == 0) {
          ...
          if (cb) {
            const char* dom_collector = 
              ...
              "    const dropClasses = ['.ad', '.ads', '.banner', '.sponsor', '.social-share', '.sns-share', '.share-box', '.comment', '.comments', '.reply', '.reply-list', '#comments', '.pagination', '.paging', '.sidebar', '.widget', '.popup', '.modal', '.footer', '.header-nav'];"
